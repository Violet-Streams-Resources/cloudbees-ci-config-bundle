...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/Violet-Streams-Resources/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>Violet-Streams-Resources</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>Violet-Streams-Resources</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/Violet-Streams-Resources/pipeline-template-catalog.git</repositoryUrl>
              <traits>
